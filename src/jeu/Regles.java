...
public class Regles extends FenetreAbstraite{
    ...
    protected  String wavAccueil() {
        return "../ressources/tts/regles.mp3";
    }
    ...
    protected void init() {
        ...
        String text = "Pour jouer, branchez les manettes a votre ordinateur. Quand l'ordinateur les aura reconues appuyez sur le bouton jouer du menu principal.\n" +
                "Vous pouvez jouer jusqu'a quatre joueurs, chaque joueur devra appuyer UNE fois sur le bouton rouge pour dire qu'il participe, puis encore une fois pour lancer la partie.\n" +
                "Pour repondre aux questions utiliser 4 petits boutons";
